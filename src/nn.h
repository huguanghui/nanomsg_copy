...
#endif // !EISCONN
#ifndef ESOCKETNOSUPPORT
#define ESOCKETNOSUPPORT (NN_HAUSNUMERO + 28)
#endif // !ESOCKETNOSUPPORT
...
NN_EXPORT int nn_symbol_info(int i, struct nn_symbol_properties *buf,
                             int buflen);
...
NN_EXPORT struct nn_cmsghdr *nn_cmsg_nxthdr_(const struct nn_msghdr *mhdr,
